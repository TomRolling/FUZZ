...
const UI_STRINGS = {
  fr: {
    ...
    tutorialBody: `<p class="tutorialIntro">Papi Feuillage a « mystérieusement » hérité de ce terrain vague. Trop occupé pour l'entretenir, il en a confié les clés à son petit-fils au chômage, <b>Leroy</b>. C'est toi.</p><ul class="tutorialTips"><li><span>👆</span><div><b>Clique</b> au centre de l'écran pour désherber et gagner de la Verdure 🌿.</div></li><li><span>🏪</span><div>Continue à désherber : quand la <b>barre du haut</b> est pleine, Papi ouvre sa boutique. Tu pourras y embaucher de l'aide qui produit toute seule, même jeu fermé.</div></li><li><span>💬</span><div>Papi repassera t'expliquer chaque nouveauté au moment où elle arrive. <b>Rien à retenir maintenant.</b></div></li></ul>`,
  ...
  en: {
    ...
    tutorialBody: `<p class="tutorialIntro">Gramps Weeds "mysteriously" inherited this vacant lot. Too busy to deal with it, he handed the keys to his unemployed grandson, <b>Leroy</b>. That's you.</p><ul class="tutorialTips"><li><span>👆</span><div><b>Click</b> the center of the screen to weed and earn Greenery 🌿.</div></li><li><span>🏪</span><div>Keep weeding: when the <b>bar at the top</b> fills up, Gramps opens his shop. There you can hire help that produces on its own, even while the game is closed.</div></li><li><span>💬</span><div>Gramps will drop by to explain each new thing when it shows up. <b>Nothing to memorise right now.</b></div></li></ul>`,
