...
const CLICK_UPGRADES = [
  ...
  { id: 'c2', name: { fr: 'Clic synchronisé', en: 'Synced Click' }, desc: { fr: "Chaque clic ajoute 0.2% de ta production/seconde.", en: "Each click adds 0.2% of your production/second." }, cost: 3000, type: 'cpsPercent', value: 0.002 },
  ...
  { id: 'c4', name: { fr: 'Clic en rafale', en: 'Burst Click' }, desc: { fr: "+0.2% supplémentaire de ta production/seconde par clic.", en: "An additional +0.2% of your production/second per click." }, cost: 400000, type: 'cpsPercent', value: 0.002 },
  ...
  { id: 'c22', name: { fr: 'Cadence naturelle', en: 'Natural Cadence' }, desc: { fr: "+0.2% supplémentaire de ta production/seconde par clic.", en: "An additional +0.2% of your production/second per click." }, cost: 2.5e+6, type: 'cpsPercent', value: 0.002 },
  ...
  { id: 'c6', name: { fr: 'Réflexes augmentés', en: 'Enhanced Reflexes' }, desc: { fr: "+0.2% supplémentaire de ta production/seconde par clic.", en: "An additional +0.2% of your production/second per click." }, cost: 6e+7, type: 'cpsPercent', value: 0.002 },
  ...
  { id: 'c8', name: { fr: 'Synchronisation neurale', en: 'Neural Sync' }, desc: { fr: "+0.25% supplémentaire de ta production/seconde par clic.", en: "An additional +0.25% of your production/second per click." }, cost: 2e+10, type: 'cpsPercent', value: 0.0025 },
  { id: 'c24', name: { fr: 'Mémoire musculaire', en: 'Muscle Memory' }, desc: { fr: "+0.25% supplémentaire de ta production/seconde par clic.", en: "An additional +0.25% of your production/second per click." }, cost: 1e+11, type: 'cpsPercent', value: 0.0025 },
  ...
  { id: 'c10', name: { fr: 'Clic quantique', en: 'Quantum Click' }, desc: { fr: "+0.25% supplémentaire de ta production/seconde par clic.", en: "An additional +0.25% of your production/second per click." }, cost: 5e+12, type: 'cpsPercent', value: 0.0025 },
  { id: 'c12', name: { fr: 'Résonance galactique', en: 'Galactic Resonance' }, desc: { fr: "+0.35% supplémentaire de ta production/seconde par clic.", en: "An additional +0.35% of your production/second per click." }, cost: 1e+15, type: 'cpsPercent', value: 0.0035 },
  { id: 'c14', name: { fr: 'Clic intergalactique', en: 'Intergalactic Click' }, desc: { fr: "+0.35% supplémentaire de ta production/seconde par clic.", en: "An additional +0.35% of your production/second per click." }, cost: 2e+17, type: 'cpsPercent', value: 0.0035 },
  { id: 'c16', name: { fr: 'Écho de mousse', en: 'Moss Echo' }, desc: { fr: "+0.4% supplémentaire de ta production/seconde par clic.", en: "An additional +0.4% of your production/second per click." }, cost: 1e+20, type: 'cpsPercent', value: 0.004 },
  { id: 'c18', name: { fr: 'Rituel du compost', en: 'Compost Ritual' }, desc: { fr: "+0.4% supplémentaire de ta production/seconde par clic.", en: "An additional +0.4% of your production/second per click." }, cost: 3e+23, type: 'cpsPercent', value: 0.004 },
  ...
  { id: 'c20', name: { fr: 'Clic hors du temps', en: 'Click Beyond Time' }, desc: { fr: "+0.45% supplémentaire de ta production/seconde par clic.", en: "An additional +0.45% of your production/second per click." }, cost: 2.5e+26, type: 'cpsPercent', value: 0.0045 },
...
const ASCENSION_UPGRADES = [
  ...
  { id: 'as_click3', name: { fr: 'Main des étoiles', en: 'Hand of the Stars' }, desc: { fr: "+20% sur tout ce que rapporte un clic.", en: "+20% on everything a click earns." }, cost: 8, type: 'clickMult', value: 1.2, requires: 'as_click2' },
  { id: 'as_prod4', name: { fr: 'Cœur de nébuleuse', en: 'Nebula Heart' }, desc: { fr: '+100% de production globale supplémentaire.', en: '+100% additional global production.' }, cost: 11, type: 'prodMult', value: 2, requires: 'as_prod3' },
  { id: 'as_knowledge3', name: { fr: "Bibliothèque de l'univers", en: 'Library of the Universe' }, desc: { fr: '+200% supplémentaire de gain de Connaissances.', en: 'An additional +200% Knowledge gain.' }, cost: 14, type: 'knowledgeMult', value: 3, requires: 'as_knowledge2' },
  { id: 'as_cheaper2', name: { fr: 'Marché galactique', en: 'Galactic Market' }, desc: { fr: 'Compagnons encore 15% moins chers.', en: 'Companions another 15% cheaper.' }, cost: 18, type: 'cheaper', value: 0.85, requires: 'as_cheaper1' },
  { id: 'as_prod5', name: { fr: 'Souffle cosmique', en: 'Cosmic Breath' }, desc: { fr: '+150% de production globale supplémentaire.', en: '+150% additional global production.' }, cost: 23, type: 'prodMult', value: 2.5, requires: 'as_prod4' },
  { id: 'as_prod6', name: { fr: 'Naissance d\'une étoile', en: 'Birth of a Star' }, desc: { fr: '+200% de production globale supplémentaire.', en: '+200% additional global production.' }, cost: 30, type: 'prodMult', value: 3, requires: 'as_prod5' },
];
